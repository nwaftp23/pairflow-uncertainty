# Nflows Base & Nflows Out

This repository is a **modified version** of [nflows](https://github.com/bayesiains/nflows), developed for research on **epistemic uncertainty estimation** in **normalizing flow ensembles**.

The modifications include:
- Added support for *ensemble training* of Normalizing Flows.  
- Introduced **Nflows Base** (ensemble in the base distribution) and **Nflows Out** (ensemble in the output distribution).  

# nflows (Original Repository)
